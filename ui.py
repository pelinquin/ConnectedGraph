...
def common(req=None,pfx='.',edit=False,user='',msg=''):
    ...
    if edit:
        ...
        o += '<text onclick="switch_mode();" fill="white" x="5" y="12" class="button">Connected Graph<title>Fork me on Github!</title></text>'
    return o + '</svg>'
...
def login_page(req):
    ...
    o += '<foreignObject display="inline" y="200" x="200" width="120" height="70">' 
